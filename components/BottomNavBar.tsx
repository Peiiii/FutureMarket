  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-3 py-2 flex items-center justify-between z-50 pb-safe shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      ...
      <div className="flex gap-2 flex-grow">
        <button className="flex-1 bg-[#fff0f3] text-[#ff4d6d] font-bold py-3 px-2 rounded-full text-[14px] whitespace-nowrap">
          加入购物车
        </button>
        <button className="flex-1 bg-gradient-to-r from-[#ff4d6d] to-[#ff1a47] text-white font-bold py-3 px-2 rounded-full text-[14px] whitespace-nowrap">
          领券预定
        </button>
      </div>
    </div>
